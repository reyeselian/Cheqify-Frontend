    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ padding: "0.75rem", borderTop: `1px solid ${S.sidebar.border}` }}>
        ...
        <button onClick={handleLogout} style={{
          ...
          color: "rgba(239,68,68,0.7)", padding: "8px 12px",
      ...
      <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Outfit', sans-serif", background: "#f1f5f9" }}>
        ...
        {mobileOpen && (
          <div style={{ position: "fixed", inset: 0, zIndex: 300, display: "flex" }}>
            ...
            <aside style={{
              position: "relative", zIndex: 1, width: S.sidebar.width,
              background: S.sidebar.bg, display: "flex", flexDirection: "column",
          ...
          <header style={{
            ...
            <div>
              ...
              <p style={{ margin: 0, color: "#94a3b8", fontSize: "0.75rem" }}>
                Panel de administración · Cheqify
              </p>
            </div>
